...
import {Pool} from "./libraries/poolsWithTransfer/Pool.sol";
import {Stake} from "./libraries/poolsWithTransfer/Stake.sol";

/// @title StakingPoolsWithTransfer
...
contract StakingPoolsWithTransfer is ReentrancyGuard {
    ...
    ///
    /// @param _poolId the pool to donate for
    /// @param _donateAmount The donate amount
    function donateReward(uint256 _poolId, uint256 _donateAmount) external nonReentrant {
        Pool.Data storage _pool = _pools.get(_poolId);
        _pool.update(_ctx);
